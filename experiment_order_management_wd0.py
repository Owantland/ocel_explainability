"""
Experiment: does removing weight_decay (0.0 instead of 1e-5) improve TimeFrom_Orders_to_PayOrder
...
official TimeFrom_Orders_to_PayOrder.pth (already backed up separately).
"""
import copy
import json
import time
...
CANT = 2000
CHECKPOINT_PATH = 'files/models/order_management/2000/Hetero/TimeFrom_Orders_to_PayOrder_wd0_experiment.pth'
